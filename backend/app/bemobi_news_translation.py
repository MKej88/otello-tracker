...
def translate_bemobi_news(
    *,
    ...
    CVM supplies Portuguese metadata rather than the filing body. Unknown free-text
    subjects are therefore represented by their official filing type instead of
    being guessed.
    """
