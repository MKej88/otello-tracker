...
def _full_row(connection, as_of_date: str):
...
def _modeled_buyback_cash(connection, *, anchor_date: str, as_of_date: str) -> dict[str, Any]:
...
def nav_waterfall_summary(database_path: str | None = None) -> dict[str, Any]:
    with get_connection(database_path) as connection:
        ...
        anchor_row = _full_row(connection, anchor_date)
        if current is None:
        ...
        anchor_options = _option_values(_components(anchor_row["components_json"]))
