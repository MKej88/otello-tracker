...
from app.estimated_nav_history_cash_display import estimated_nav_history
from app.estimated_nav_history_display import _report_split_state
from app.historical_investment_attribution import (
    apply_historical_life360_change_split,
)
from app.life360_nav import LIFE360_FAIR_VALUE_POLICY_START, life360_market_value
...
def _investment_report_for_nav_date(
    ...
    return _report_split_state(database_path, report_date)
...
def _estimated_extension(
    ...
    if change.get("ready"):
        ...
        if resolved_start and resolved_start < LIFE360_FAIR_VALUE_POLICY_START:
            start_life360 = life360_market_value(
                as_of_date=resolved_start,
                database_path=database_path,
            )
            current_life360 = life360_market_value(
