...
import estimated_nav_history_cash_display_base as _base

# Preserve the existing module surface, including private helpers used by parity tests.
...
async def estimated_nav_history(
    ...
    *,
    ...
    result = await _base_estimated_nav_history(
        repository,
        days=days,
    ...
    patent = await _period_patent_proceeds(
        repository,
