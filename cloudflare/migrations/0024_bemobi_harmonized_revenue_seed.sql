-- Seed Bemobi's harmonized net-revenue series for the latest four TTM quarters.
--
-- These values come from Bemobi's official result releases and remove the M4U gross-up
-- effect used in statutory CVM DRE 3.01. The statutory revenue field remains untouched and
-- continues to serve as the regulatory control series.
